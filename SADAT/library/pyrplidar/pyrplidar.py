from library.pyrplidar.pyrplidar_serial import PyRPlidarSerial
from library.pyrplidar.pyrplidar_protocol import *
import library.pyrplidar.pyrplidar_protocol
...
class PyRPlidar:
    ...
    def connect(self, port="/dev/ttyUSB0", baudrate=115200, timeout=3, isWindows=False):
        self.lidar_serial = PyRPlidarSerial()
        self.lidar_serial.open(port, baudrate, timeout, isWindows)
